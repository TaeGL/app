					...
					<div class="container">
						<div class="container-main">
							<c:forEach var="dto" items="${recipes}">
								...
								<div class="myRecipeComment-link">
									<a href="/recipe/recipeInfo/${dto.recipe_no }">
									<!-- Content -->
										<div id="content">
											<section class="myRecipeComments">
												<p class="rc-head">${dto.recipe_comment }</p>
												<p class="rc-main">${dto.comment_date }</p>
												<p class="rc-main">
													${dto.recipe_name }
												</p>
						...
						<div class="page">
							<c:if test="${page>1}">
								<a href="/member/myPage/myComments?page=${page-1}">&lt;</a>
							</c:if>
							<c:forEach begin="${firstPage}" end="${lastPage}" step="1" var="i">
								<c:choose>
									...
									<c:otherwise>
										<a href="/member/myPage/myComments?page=${i}">${i}</a>
									</c:otherwise>
								</c:choose>								
							</c:forEach>

	...
	<body class="is-preload homepage">
		<div id="page-wrapper">
			...
			<!-- Main -->
				...
				<!-- Features -->
					<div id="makeRecipeMain" style="margin-top: 100px;">
						<form action="/recipe/recipeInfoEdit" id="editRecipe" name="editRecipe" method="post" enctype="multipart/form-data">
							...
							<th>
								<input class="" name="recipe_name" id="recipe_name" type="text" value="${recipe.recipe_name }" style="width: 50%">
							</th>
							</tr>
							<tr>
							<th>
							...
							<th>
								<div class="image-container">
								    ...
								    <img width="150px;" height="150px;" id="preview-image" name="preview-image" src="${cp}/resources/images/userRecipeImage/${recipe.recipe_image }">
							...
							<th>
								<input class="" type="radio" value="" style="width: 50%;" >
							      ...
							      <tr>
							         ...
							         <td><textarea name="cook_ingredient" id="cook_ingredient" rows="5" cols="70" style="resize: none;" placeholder="여기에 재료 입력..">${recipe.cook_ingredient }</textarea></td>
							...
							<td colspan = "2" align = "center">
								<textarea name="recipe_contents" id="recipe_contents" rows="20" cols="110" style="resize: none;" >${recipe.recipe_contents }</textarea>
							</td>
							</tr>
							<tr>
							<td colspan="2" align="center">
								<input type="hidden" name="user_id" id="user_id" value="${recipe.user_id}" >
								<input type="hidden" name="recipe_date" id="recipe_date" value="${recipe.recipe_date}" >
								<input type="hidden" name="recipe_no" id="recipe_no" value="${recipe.recipe_no}" >
								<input type="button" onclick="editRecipeCheck();" value="레시피 수정">
							</td>
							</tr>
							</table>
						</form>

		...
		<div class="body-recipeDelsection-main">
			...
			<form action="/member/join/checkIdLogic" method="post" id="checkIdForm" name="checkIdForm">
				<div class="recipeDel-main">
					<h1>답글을 정말 삭제하시겟습니까?</h1>
					<input type="button" value="YES" readonly="readonly" onclick="deleteQuestionCommentsLogic(${cNo});">
					<input type="button" value="NO" onclick="delQuestionCommentsNo();">

			...
			<!-- Main -->
				...
				<div id="main-wrapper">
					<div class="container">
							...
							<div class="col-8 col-12-medium imp-medium">
								...
								<div class="customerService-main-right">
									<section>
										...
										<thead>
											<tr>
												<th class="t-col-no">번호</th>
												<th class="t-col-title">제목</th>
												<th class="t-col-date">작성일</th>
											</tr>
										...
										<c:forEach var="dto" items="${list}">
											<tr>
												<td>
													<a href="/customerManage/customerServiceInfo/${dto.board_no}">
														${dto.board_no}																
													</a>
												</td>
												<td>
										...
										<c:if test="${sessionScope.login.user_grade=='운영자' }">
											<button class="button-align-right" onclick="location.href='/customerManage/csInsertView'">글쓰기</button>
										</c:if>
									</section>
								</div>
							</div>
						...
						<div class="page">
							<c:if test="${page>1}">
								<a href="/customerManage/customerService?page=${page-1}">&lt;</a>
							</c:if>
							<c:forEach begin="${firstPage}" end="${lastPage}" step="1" var="i">
								<c:choose>
									...
									<c:otherwise>
										<a href="/customerManage/customerService?page=${i}">${i}</a>
									</c:otherwise>
								</c:choose>								
							</c:forEach>
